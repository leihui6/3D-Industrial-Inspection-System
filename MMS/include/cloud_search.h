...
public:
	...
	void search_points_correspondence(std::vector<point_3d>& points, std::set <size_t> & correspondences_index, float dis_threshold);

	void search_points_correspondence(std::vector<point_3d>& points, std::vector<point_3d>& correspondences_points);
